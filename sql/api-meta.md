...
> The metadata will be provided even if one of the metrics referenced in the query does not exist in the database. In this case, the metric value column will be of the default `float` datatype.
