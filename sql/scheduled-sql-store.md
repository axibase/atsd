...
| `time` | long | `0-1` | The date of the record in Unix time with millisecond precision (1). |
...
| `tags` | string | `0-*` | Series tags for the stored series, encoded as `key=value` pairs separated by semi-colon.<br>Cell value contains tag names and values.|
