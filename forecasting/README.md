...
Use the split-button on the **Data > Forecasts** page to add [Exceptions](calendar_exceptions_testing.md#exceptions) and perform [Testing](calendar_exceptions_testing.md#testing).
