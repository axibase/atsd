...
| Issue| Category    | Type    | Subject                                                             |
|------|-------------|---------|----------------------
| [4153](#issue-4153) | box | Bug | Fixed an auto-scaling error for aggregated series in the [Box Widget](https://github.com/axibase/charts/tree/master/widgets/box-chart#percentile-markers). |
