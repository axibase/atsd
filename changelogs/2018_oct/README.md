...
5727 | sql | Bug | [SQL](../../sql/README.md): Incorrect arithmetic operator precedence. |
5726 | sql | Feature | [SQL](../../sql/README.md): implement [metadata tables](../../sql/README.md#tables): `atsd_metric` and `atsd_entity`. |
5725 | installation | Bug | [Docker Installation](../../installation/images.md): `LicenseServiceImpl` error. |
5723 | sql | Bug | [SQL](../../sql/README.md): `NullPointerException` on Compare. |
...
5717 | rule engine | Bug | [Rule Engine](../../rule-engine/README.md): Rule threshold notifications are not properly exported. |
5716 | rule editor | Bug | [Rule Engine](../../rule-engine/README.md): Long URL after rule clone. |
...
5709 | rule engine | Feature | [Rule Engine](../../rule-engine/README.md): Implement **Test** for Message and Property rules. |
...
5660 | rule editor | Bug | Rule Editor: `500` error upon [webhook](../../rule-engine/notifications/README.md) deletion. |
...
5589 | rule engine | Bug | [Rule Engine](../../rule-engine/README.md): Review notification thresholds. |
5564 | rule editor | Feature | [Email](../../rule-engine/email.md) and [Webhook](../../rule-engine/notifications/README.md) action validation. |
