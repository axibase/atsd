...
Implemented [date functions](../../rule-engine/functions-date.md) in the rule engine to convert an ISO8601 date string into a numeric Unix time or into a [`DateTime`](http://joda-time.sourceforge.net/apidocs/org/joda/time/DateTime.html) date object. These functions can be used in rule expressions.
