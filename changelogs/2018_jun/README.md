...
5411 | message | Bug | [Message Table TTL](../../api/data/messages/delete.md) specified in `server.properties` is ignored.
...
5399 | test | Bug | API Tests: Message tests fail if [`messages.timeToLive`](../../api/data/messages/delete.md) is too low.
