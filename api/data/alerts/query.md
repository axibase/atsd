...
| `openDate` | string | [ISO date](../../../shared/date-format.md#supported-formats) for alert open.  |
| `lastEventDate` | string | [ISO date](../../../shared/date-format.md#supported-formats) for the last received record.  |
