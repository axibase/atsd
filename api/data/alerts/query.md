...
| `openDate` | string | [ISO format date](../../../shared/date-format.md) for alert open.  |
| `lastEventDate` | string | [ISO format date](../../../shared/date-format.md) for the last received record.  |
