...
| `startDate` | string | **[Required]** [ISO date](../../../shared/date-format.md#supported-formats) or [calendar](../../../shared/calendar.md) keyword. <br>Delete records updated at or after the specified time. |
| `endDate` | string | **[Required]** [ISO date](../../../shared/date-format.md#supported-formats) or [calendar](../../../shared/calendar.md) keyword.<br>Delete records updated before the specified time. |
