...
| `startDate` | string | **[Required]** [ISO format date](../../../shared/date-format.md) or [calendar](../../../shared/calendar.md) keyword. <br>Delete records updated at or after the specified time. |
| `endDate` | string | **[Required]** [ISO format date](../../../shared/date-format.md) or [calendar](../../../shared/calendar.md) keyword.<br>Delete records updated before the specified time. |
