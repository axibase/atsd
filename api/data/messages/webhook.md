...
This method can be used to process HTTP notifications from services that supportå webhooks such as GitHub, AWS SNS, Jenkins, Docker Hub, Slack/Telegram/Discord Bots etc.
