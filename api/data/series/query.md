...
* Sample time can be specified as Unix time with millisecond granularity (`t` field) or [ISO format](../../../shared/date-format.md) (`d` field).

|**Name**|**Type**|**Description**|
|:---|:---|:---|
| `t` | integer | Unix time in milliseconds.|
| `d` | string | Sample time in [ISO format](../../../shared/date-format.md). |
