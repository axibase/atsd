...
Filter versions with the `version_time` field which returns value change time in milliseconds.
...
[
  {
    ...
    "metric": "m-vers",
    "versioned": true,
    "versionFilter": "version_time >= date('2015-08-13T13:00:00Z') && version_time < date('2015-08-13T14:00:00Z')"
  }
]
```
