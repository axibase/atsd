...
* [Allocating Memory to components](allocating-memory.md#allocating-memory-to-components)
  * [Change maximum ATSD process memory](allocating-memory.md#atsd-heap)
  * [Change maximum HBase process memory](allocating-memory.md#hbase-heap)
  * [Change maximum HDFS process memory](allocating-memory.md#hdfs-heap)
