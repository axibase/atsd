...
To disable a metric, open the **Metric Editor**, expand **Settings** section, set **Enabled** to **No**, and click **Save**.
...
To disable persistence for a metric, open the **Metric Editor**, expand **Settings** section, set **Persistent** to **No**, and click **Save**.
...
To set the filter for a metric, open the **Metric Editor**, expand the **Settings** section, enter an expression into **Persistence Filter**, and click **Save**.
...
To delete **old data** beyond the retention period for the selected metric, open the **Metric Editor**, expand the **Settings** section, and set **Retention Days** to a positive integer, click **Save**.

To disable deletion, set **Retention Days** back to zero.
...
To delete **all data** for an old series, open the **Metric Editor**, expand the **Settings** section, and set **Series Retention Days** to a positive integer, click **Save**.

To disable deletion, set **Series Retention Days** back to zero.
