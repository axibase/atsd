...
| Messages | `atsd_messages` | [Deleted](../api/data/messages/delete.md) after 1 year. |
...
To delete a single entity, locate the entity on the **Entities** tab, open the entity editor and click **Delete**.
...
To delete a single metric, locate the metric on the **Metrics** tab, open the metric editor and click **Delete**.
