...
It can take a few seconds for the first commands to arrive and to trigger the webhooks. Refresh the **Alerts > Open Alerts** page to verify that an alert is open for your rule.
