...
The webhook request is successful if the endpoint returns HTTP `2xx` status code.
...
The webhook request executes successfully if the endpoint returns HTTP `2xx` status code.
