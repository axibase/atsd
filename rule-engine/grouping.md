...
**Data Type** and **Metric Name** are mandatory parts of the key whereas grouping by entity and tags is optional and can be configured for each rule separately.
