...
Assuming that incoming data is represented with the 3 series commands shown here, the examples below will illustrate the effect of group settings on window formations.
