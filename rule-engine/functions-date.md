...
> [`command_time`](./window-fields.md#date-fields) is a [`DateTime`](object-datetime.md) object containing the sample time of most recently added or removed command.
