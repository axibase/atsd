...
* Финансовые функции с оптимальным вычислением на сервере: OHLCV, VWAP, Beta, COVAR, CORREL, etc
...
* Экспорт [исходных сделок](./trades-export.md) в формате CSV
* Экспорт [агрегированных сделок](./ohlcv-export.md) (OHLCV + VWAP) в формате CSV
* Экспорт [статистик и котировок](./statistics-export.md) в формате JSON
* Экспорт [итогов сессий](./session-summary-export.md) в формате JSON
