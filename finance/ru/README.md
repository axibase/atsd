...
ATSD предлагает клиентам удобные средства экспорта, обработки и интерактивного анализа исходных и производных данных для разработки торговых стратегий, анализа транзакционных издержек, а также надзорных исследований и контроля рисков.
...
* Дополнительные утилиты для подгрузки и проверки референтных данных из ISS
