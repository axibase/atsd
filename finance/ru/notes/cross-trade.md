...
Архивные данные типа А публикуются на следующий день после окончания торговой сессии и содержат анонимизированные параметры всех заявок, включая заявки с моментальным исполнением и снятым остатком. Тем не менее, архивы не содержат информацию о типе заявки и причинах снятия остатка.
...
В примере ниже, заявка на продажу по 53.615 руб. исполняется частично несмотря на наличие в книге заявок покупок на уровне 54.115.
...
23 апреля 2021 в течение основной сессии зарегистрировано **145,8 тысяч** кросс-заявок, однако практически все заявки в количестве 144,7 тысяч относятся к акциям [`SWN-RM`](https://www.moex.com/ru/issue.aspx?board=FQBR&code=SWN-RM).
...
Допущенные биржей кросс-сделки исполняются как обычные сделки без снятия остатка, и поэтому не могут быть определены на основании вышеприведенных критериев. Количество таких разрешенных кросс-сделок в настоящий момент неизвестно.

В контексте квалифицированных инвесторов и [доверительного управления](https://www.moex.com/n33723/?nt=107), вполне возможно, что речь идет о вариантах стратегий, когда кросс-сделка проводится без воздействия на рынок, например в целях сглаживания финансового результата путем псевдо-фиксации убытков по отдельным позициям в портфеле в конце налогового периода. Налоговое законодательство не запрещает данный тип сделок, но следует учитывать риск отнесения сделки к необоснованной налоговой оптимизации.

### Мониторинг манипулирования

Основной уязвимостью использования кросс-сделок для целей обнаружения недобросовестных практик является тот факт, что такие манипуляции как правило производятся группой лиц. Пользуясь случаем вспомним, что "манипула" на латыни означала роту солдат в древнеримской армии. Наврядли группы недобросовестных участников задействуют такие "коллективы", однако даже двух клиентов второго уровня достаточно для обхода запретов на кросс-сделки. В настоящий момент, запрет на кросс-сделки лишает регулятора ранних индикаторов противоправной деятельности, и при этом не защищает рынок от профессиональных манипуляторов.
