...
* Поток `S` (statictics) содержит несколько сообщений об изменении книги заявок с учетом всех заявок, обработанных к моменту времени `Event Time` равному `10:51:12.783533`.
...
Для получения рыночных данных и отправки заявок в торговые интерфейсы Московской Биржи, клиенту необходимо самостоятельно установить и эксплуатировать программное обеспечение. Данное ПО можно разработать самостоятельно или использовать готовые системы быстрого старта. Одним из таких решений, прошедших сертификацию Московской Биржи, является [АТСД](../README.md).