...
For the purpose of instruction, we will use the following sample [`series` commands](https://github.com/axibase/atsd/blob/master/integration/spss/modeler/resources/commands.txt).
...
Download the [stream file](https://github.com/axibase/atsd/blob/master/integration/spss/modeler/resources/Stream.str) used for this guide for review in your own IBM SPSS Modeler installation.
