...
Custom portals can be created using [HTML5 Widgets](https://github.com/axibase/charts/blob/master/README.md#axibase-charts) to visualize any combination of collected [`nmon` metrics](./format.md).

[![](./resources/widget-bar-2.png "widget bar 2")](https://github.com/axibase/charts/blob/master/widgets/README.md)
...
[Forecasting](../../forecasting/README.md) tools for analyzing and planning capacity. Custom portals can be created using [HTML5 widgets](https://github.com/axibase/charts/blob/master/README.md#axibase-charts).
