...
For the purpose of instruction, we will use sample [`series` commands](https://github.com/axibase/atsd/blob/master/integration/alteryx/resources/commands.txt).
