...
* [Apache Derby](https://axibase.com/docs/axibase-collector/jobs/examples/derby/)
...
* [Jetty Web Server](https://axibase.com/docs/axibase-collector/jobs/examples/jetty/)
* [Java Virtual Machine](https://axibase.com/docs/axibase-collector/jobs/examples/jvm/)
...
* [MySQL Server](https://axibase.com/docs/axibase-collector/jobs/examples/mysql/)
* [nginx Web Server](https://axibase.com/docs/axibase-collector/jobs/examples/nginx/)
* [nginx PLUS Web Server](https://axibase.com/docs/axibase-collector/jobs/examples/nginx-plus/)
...
* [Tomcat Servlet Container](https://axibase.com/docs/axibase-collector/jobs/examples/tomcat/)
* [VMWare](https://axibase.com/docs/axibase-collector/jobs/examples/vmware/)
